...
(declare-function telega-chat-leave "telega-chat" (chat &optional keep-chatbuf))
...
(declare-function telega-chat-toggle-archive "telega-chat" (chat))
(declare-function telega-chat-user "telega-chat" (chat))
(declare-function telega-chatbuf--chat-update "telega-chat" (&rest dirtiness))
(declare-function telega-chatbuf--filter-match-msg-p "telega-chat" (msg))
(declare-function telega-chatbuf--input-imcs "telega-chat" (markup-name &optional input))
...
(declare-function telega-chatbuf-filter-by-saved-messages-tag "telega-chat" (tag &optional query))
(declare-function telega-chatbuf-msg-marks-toggle "telega-chat" ())
(declare-function telega-msg-redisplay "telega-chat" (msg &optional node))
(declare-function telega-msg--content-file "telega-msg" (msg))
(declare-function telega-msg--set-link-preview-options "telega-msg" (msg tl-lp-options))
...
(declare-function telega-msg-disable-link-preview "telega-msg" (msg))
(declare-function telega-msg-for-interactive "telega-msg" ())
(declare-function telega-msg-goto "telega-msg" (msg &optional highlight-p callback))
