...
(declare-function telega-chat-share-my-contact "telega-chat" (chat))
(declare-function telega-chat-with "telega-chat" (chat-or-user))
(declare-function telega-chatbuf--footer-update "telega-chat" ())
...
(declare-function telega-ins--document-header "telega-ins" (doc &optional no-attach-symbol))
(declare-function telega-ins--image "telega-ins" (img &optional slice-num &rest props))
(declare-function telega-ins--location "telega-ins" (location))
