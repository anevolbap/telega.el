...
(declare-function telega-msg--replied-message "telega-msg" (msg))
(declare-function telega-msg--replied-story "telega-msg" (msg))
(declare-function telega-msg-by-me-p "telega-msg" (msg))
(declare-function telega-msg-chat "telega-msg" (msg &optional offline-p))
(declare-function telega-msg-checklist-task-add "telega-msg" (msg))
(declare-function telega-msg-checklist-task-edit "telega-msg" (msg))
(declare-function telega-msg-checklist-task-toggle "telega-msg" (msg))
(declare-function telega-msg-emojis-only-p "telega-msg" (msg))
(declare-function telega-msg-favorite-p "telega-msg" (msg))
(declare-function telega-msg-marked-p "telega-msg" (msg))
(declare-function telega-msg-media-spoiler-toggle "telega-msg" (msg))
(declare-function telega-msg-open-content "telega-msg" (msg &optional clicked-p))
(declare-function telega-msg-open-gift "telega-msg" (msg))
(declare-function telega-msg-open-poll "telega-msg" (msg))
(declare-function telega-msg-open-thread-or-topic "telega-msg" (msg))
(declare-function telega-msg-p "telega-msg" (obj))
(declare-function telega-msg-poll-add-option "telega-msg" (msg))
(declare-function telega-msg-poll-stop "telega-msg" (msg))
(declare-function telega-msg-public-forwards "telega-msg" (msg))
(declare-function telega-msg-replies-count "telega-msg" (msg))
(declare-function telega-msg-replies-has-unread-p "telega-msg" (msg))
(declare-function telega-msg-resend "telega-msg" (msg))
(declare-function telega-msg-rich-message-show-full "telega-msg" (msg))
...
(declare-function telega-msg-sender-title--special "telega-msg" (msg-sender &rest args))
...
(declare-function telega-msg-summarize "telega-msg" (msg &optional to-language-code tone quiet))
(declare-function telega-msg-translate "telega-msg" (msg &optional to-language-code tone quiet))
(declare-function telega-sponsored-msg--action "telega-msg" (button))
(declare-function telega-chat-notification-setting "telega-notifications" (chat setting &optional topic))
(declare-function telega-voip--by-user-id "telega-voip" (user-id))
(declare-function telega-voip--call-emojis "telega-voip" (call))
(declare-function telega-msg--vvnote-play-speed-toggle "telega-vvnote" (msg))
(declare-function telega-msg--vvnote-rewind "telega-vvnote" (msg step))
(declare-function telega-msg--vvnote-stop "telega-vvnote" (msg))
(declare-function telega-vvnote--waveform-decode "telega-vvnote" (waveform &optional raw-p))
(declare-function telega-vvnote--waves-svg "telega-vvnote" (waves duration &optional played))
(declare-function telega-vvnote-video--create-image "telega-vvnote" (note &optional _file with-noise-p))
(declare-function telega-vvnote-video--create-image-one-line "telega-vvnote" (note &optional file))
(declare-function telega-vvnote-video--svg "telega-vvnote" (framefile &key as-data-image-type
                                              progress with-noise-p))
(declare-function telega-vvnote-video-ttl--create-image "telega-vvnote" (note &optional file))
(declare-function telega-vvnote-video-ttl--create-image-one-line "telega-vvnote" (note &optional file))
